...
import com.tiy.ssa.week2.assignment2.Name;
import com.tiy.ssa.week2.assignment3.SocialSecurityNumber;
import com.tiy.ssa.week2.registry.Registry.Relationship;
...
public class RegistryTests
{
    ...
    public void universe()
    {
        ...
        assertEquals(greatGrandfather, registry.progenitor(new SocialSecurityNumber("212345670")));
        assertEquals(greatGrandfather, registry.progenitor(new SocialSecurityNumber("412345673")));
        assertEquals(greatGrandfather, registry.progenitor(new SocialSecurityNumber("412345670")));
       
        for(Person p : registry.ancestors(new SocialSecurityNumber("412345670")))
            System.out.println(p.getName().getFirst());

        assertEquals(Relationship.GRANDCHILD, registry.related(new SocialSecurityNumber("212345672"), new SocialSecurityNumber("412345670")));
        assertEquals(Relationship.COUSIN, registry.related(adam.getSsn(), jennifer.getSsn()));
        assertEquals(Relationship.AUNCLE, registry.related(jennifer.getSsn(), new SocialSecurityNumber("212345671")));
        assertEquals(Relationship.PARENT, registry.related(new SocialSecurityNumber("412345670"), new SocialSecurityNumber("312345670")));

       
        assertTrue(registry.areRelated(new SocialSecurityNumber("412345670"), new SocialSecurityNumber("312345670")));
        assertTrue(registry.areRelated(new SocialSecurityNumber("412345670"), new SocialSecurityNumber("212345672")));
        
        assertFalse(registry.areRelated(new SocialSecurityNumber("212345672"), aunt.getSsn()));
